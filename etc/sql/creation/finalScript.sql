-- Table: ts6.ttmpdelete

-- DROP TABLE ts6.ttmpdelete;

CREATE TABLE ts6.ttmpdelete
(
  id integer NOT NULL
)
WITH (
...
ALTER TABLE ts6.ttmpdelete OWNER TO postgres;
GRANT ALL ON TABLE ts6.ttmpdelete TO postgres;
GRANT SELECT, UPDATE, INSERT, DELETE ON TABLE ts6.ttmpdelete TO teamsched_group;
